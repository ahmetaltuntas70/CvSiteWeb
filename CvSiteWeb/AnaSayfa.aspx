<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="CvSiteWeb.AnaSayfa" %>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">
            <span class="d-block d-lg-none">AHMET ALTUNTAŞ</span>
            <span class="d-none d-lg-block">
                <asp:Repeater ID="Repeater7" runat="server">
                    <ItemTemplate>
                        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src='<%# Eval("FOTOGRAF") %>' alt="px">
                    </ItemTemplate>
                </asp:Repeater>
            </span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#experience">PROJELER</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#education">EĞİTİM</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#skills">BECERİLER</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#interests">İLGİ ALANLARI</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#awards">SERTİFİKA VE KURSLAR</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="AdminGirisYap.aspx">ADMİN GİRİŞ</a>
                </li>
                <%-- <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="AdminIletisim.aspx">İLETİŞİM</a>
                </li>--%>
            </ul>
        </div>
    </nav>
    ...
    <div class="container-fluid p-0">
                    ...
                    <div class="my-auto">
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                ...
                                <p>
                                    <h5>GENEL NOT:
                                        <asp:Label ID="Label14" runat="server" Text='<%# Eval("GNOT") %>'></asp:Label></h5>
                                </p>
                            </div>
                            <div class="resume-date text-md-right">
                                <span class="text-primary">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
            <div class="my-auto">
                ...
                <div class="subheading mb-3">YETENEKLER</div>
                <asp:Repeater ID="Repeater4" runat="server">
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                <i class="fa-li fa fa-check"></i>
                                <asp:Label ID="Label18" runat="server" Text='<%# Eval("BECERI") %>'></asp:Label></li>
                        </ul>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
            ...
            <div class="my-auto">
                ...
                <asp:Repeater ID="Repeater5" runat="server">
                    <ItemTemplate>
                        <li>
                            <i class="fa-li fa fa-check"></i>
                            <asp:Label ID="Label16" runat="server" Text='<%# Eval ("ILGI") %>'></asp:Label></li>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
        </section>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
            <div class="my-auto">
                <h2 class="mb-5">SERTİFİKALAR &amp; KURSLAR</h2>
                <asp:Repeater ID="Repeater6" runat="server">
                    <ItemTemplate>
                        <ul class="fa-ul mb-0">
                            <li>
                                <i class="fa-li fa fa-trophy text-warning"></i>
                                <asp:Label ID="Label17" runat="server" Text='<%# Eval("KURS") %>'></asp:Label></li>
                        </ul>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
        ...
        <section class="wedo" id="contact">
            <div class="contact_grid_right mt-5 mx-auto text-left">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <asp:Button ID="Button2" runat="server" CssClass="btn btn-warning" Text="İPTAL ET" />
